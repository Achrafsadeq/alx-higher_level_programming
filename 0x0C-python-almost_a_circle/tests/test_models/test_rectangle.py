#!/usr/bin/python3
'''This module contains Rectangle unit tests.'''
import unittest
...
class TestRectangle(unittest.TestCase):
    '''This class tests the Base class functionality.'''

    def setUp(self):
        '''Prepares the test environment for each method.'''
    ...
    def test_A_class(self):
        '''Verifies the Rectangle class type is correct.'''
        self.assertEqual(str(Rectangle),
                         "<class 'models.rectangle.Rectangle'>")

    def test_B_inheritance(self):
        '''Checks if Rectangle inherits from Base class.'''
...
and 'height'"
    ...
    def test_C_constructor_many_args(self):
        '''Tests the constructor with too many arguments.'''
        with self.assertRaises(TypeError) as e:
...
given"
    ...
    def test_C_constructor_one_args(self):
        '''Tests the constructor with one argument.'''
        with self.assertRaises(TypeError) as e:
            r = Rectangle(1)
    ...
    def test_D_instantiation(self):
        '''Verifies proper instantiation of Rectangle.'''
        r = Rectangle(10, 20)
    ...
    def test_D_instantiation_positional(self):
        '''Tests positional argument instantiation.'''
    ...
    def test_D_instantiation_keyword(self):
        '''Tests keyword argument instantiation.'''
    ...
    def test_E_id_inherited(self):
        '''Checks if id is inherited from Base class.'''
        Base._Base__nb_objects = 98
        r = Rectangle(2, 4)
        self.assertEqual(r.id, 99)

    def test_F_properties(self):
        '''Verifies property getters and setters.'''
        r = Rectangle(5, 9)
        r.width = 100
        r.height = 101
        r.x = 102
    ...
    def invalid_types(self):
        '''Provides tuple of invalid types for testing.'''
        t = (3.14, -1.1, float('inf'), float('-inf'), True, "str", (2,),
             [4], {5}, {6: 7}, None)
        return t

    def test_G_validate_type(self):
        '''Checks property type validation.'''
        r = Rectangle(1, 2)
    ...
    def test_G_validate_value_negative_gt(self):
        '''Tests property value validation (> 0).'''
        r = Rectangle(1, 2)
    ...
    def test_G_validate_value_zero(self):
        '''Verifies property validation for zero values.'''
        r = Rectangle(1, 2)
        attributes = ["width", "height"]
        for attribute in attributes:
            s = "{} must be > 0".format(attribute)
    ...
    def test_H_property(self):
        '''Tests property setting and getting.'''
        r = Rectangle(1, 2)
        attributes = ["x", "y", "width", "height"]
        for attribute in attributes:
            n = randrange(10) + 1
    ...
    def test_H_property_range_zero(self):
        '''Checks property setting/getting for zero.'''
        r = Rectangle(1, 2)
        r.x = 0
        r.y = 0
    ...
    def test_I_area_no_args(self):
        '''Verifies area() method signature.'''
        r = Rectangle(5, 6)
        with self.assertRaises(TypeError) as e:
            Rectangle.area()
    ...
    def test_J_display_no_args(self):
        '''Checks display() method signature.'''
        r = Rectangle(9, 8)
        with self.assertRaises(TypeError) as e:
            Rectangle.display()
    ...
    def test_J_display_simple(self):
        '''Verifies display() method output.'''
        r = Rectangle(1, 1)
        f = io.StringIO()
...
"""
    ...
    def test_K_str_no_args(self):
        '''Verifies __str__() method signature.'''
        r = Rectangle(5, 2)
        with self.assertRaises(TypeError) as e:
            Rectangle.__str__()
    ...
    def test_K_str(self):
        '''Tests __str__() method return value.'''
        r = Rectangle(5, 2)
    ...
    def test_L_update_no_args(self):
        '''Checks update() method signature.'''
        r = Rectangle(5, 2)
        with self.assertRaises(TypeError) as e:
            Rectangle.update()
    ...
    def test_L_update_args(self):
        '''Tests update() with positional arguments.'''
        r = Rectangle(5, 2)
        d = r.__dict__.copy()
    ...
    def test_L_update_args_bad(self):
        '''Tests update() with invalid positional args.'''
        r = Rectangle(5, 2)
        d = r.__dict__.copy()
    ...
    def test_L_update_kwargs_2(self):
        '''Tests update() with multiple keyword args.'''
        r = Rectangle(5, 2)
        d = r.__dict__.copy()
    ...
    def test_M_to_dictionary(self):
        '''Checks to_dictionary() method signature.'''
        with self.assertRaises(TypeError) as e:
