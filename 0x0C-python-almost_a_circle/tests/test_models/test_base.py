...
class TestBase(unittest.TestCase):
    '''Test suite for the Base class functionality.'''
    ...
    def test_A_nb_objects_private(self):
        '''Verifies nb_objects is a private class attribute.'''
        self.assertTrue(hasattr(Base, "_Base__nb_objects"))

    def test_B_nb_objects_initialized(self):
        '''Checks if nb_objects is initialized to zero.'''
    ...
    def test_D_constructor(self):
        '''Verifies the constructor's signature.'''
    ...
    def test_D_constructor_args_2(self):
        '''Tests constructor with 2 non-self arguments.'''
        with self.assertRaises(TypeError) as e:
...
were given"
    ...
    def test_E_consecutive_ids(self):
        '''Checks for correct assignment of consecutive ids.'''
        b1 = Base()
        b2 = Base()
        self.assertEqual(b1.id + 1, b2.id)

    def test_F_id_synced(self):
        '''Ensures sync between class and instance id.'''
        b = Base()
        self.assertEqual(getattr(Base, "_Base__nb_objects"), b.id)

    def test_F_id_synced_more(self):
        '''Further tests id synchronization.'''
        b = Base()
        b = Base("Foo")
        b = Base(98)
        b = Base()
    ...
    def test_G_custom_id_int(self):
        '''Verifies custom integer id assignment.'''
        i = 98
        b = Base(i)
        self.assertEqual(b.id, i)

    def test_G_custom_id_str(self):
        '''Checks custom string id assignment.'''
        i = "FooBar"
        b = Base(i)
        self.assertEqual(b.id, i)
    ...
    def test_H_to_json_string(self):
        '''Validates to_json_string() method functionality.'''
        with self.assertRaises(TypeError) as e:
            Base.to_json_string()
...
'list_dictionaries'"
    ...
    def test_H_test_from_json_string(self):
        '''Checks from_json_string() method functionality.'''
        with self.assertRaises(TypeError) as e:
...
"height": 34340}]'
    ...
    def test_I_save_to_file(self):
        '''Verifies save_to_file() method functionality.'''
        import os
        r1 = Rectangle(10, 7, 2, 8)
        r2 = Rectangle(2, 4)
    ...
    def test_J_create(self):
        '''Tests the create() method functionality.'''
        r1 = Rectangle(3, 5, 1)
    ...
    def test_K_load_from_file(self):
        '''Validates load_from_file() method functionality.'''
        r1 = Rectangle(10, 7, 2, 8)
        r2 = Rectangle(2, 4)
        list_in = [r1, r2]
