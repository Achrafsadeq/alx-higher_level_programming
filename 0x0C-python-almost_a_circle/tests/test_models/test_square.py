#!/usr/bin/python3
'''Comprehensive unit tests for Square class.'''
import unittest
...
class TestSquare(unittest.TestCase):
    '''Extensive test suite for Square class.'''
    ...
    def test_A_class(self):
        '''Verifies Square class type and structure.'''
        self.assertEqual(str(Square),
                         "<class 'models.square.Square'>")

    def test_B_inheritance(self):
        '''Ensures Square properly inherits from Base.'''
        self.assertTrue(issubclass(Square, Base))

    def test_C_constructor_no_args(self):
        '''Checks constructor behavior with no args.'''
    ...
    def test_C_constructor_many_args(self):
        '''Examines constructor with excess arguments.'''
        with self.assertRaises(TypeError) as e:
            r = Square(1, 2, 3, 4, 5)
...
were given"
    ...
    def test_D_instantiation(self):
        '''Tests various instantiation scenarios.'''
        r = Square(10)
    ...
    def test_D_instantiation_positional(self):
        '''Verifies positional argument instantiation.'''
        r = Square(5, 10, 15)
    ...
    def test_E_id_inherited(self):
        '''Checks if id is correctly inherited.'''
        Base._Base__nb_objects = 98
        r = Square(2)
        self.assertEqual(r.id, 99)

    def test_F_properties(self):
        '''Examines property getters and setters.'''
        r = Square(5, 9)
        r.size = 98
        r.x = 102
        r.y = 103
    ...
    def test_G_validate_value_negative_gt(self):
        '''Tests validation for negative values.'''
        r = Square(1, 2)
        attributes = ["size"]
        for attribute in attributes:
    ...
    def test_G_validate_value_negative_ge(self):
        '''Checks validation for non-negative values.'''
        r = Square(1, 2)
        attributes = ["x", "y"]
        for attribute in attributes:
    ...
    def test_G_validate_value_zero(self):
        '''Verifies validation for zero values.'''
        r = Square(1, 2)
        attributes = ["size"]
        for attribute in attributes:
            s = "width must be > 0".format(attribute)
    ...
    def test_H_property(self):
        '''Tests property getting and setting.'''
        r = Square(1, 2)
    ...
    def test_H_property_range_zero(self):
        '''Checks property setting with zero.'''
        r = Square(1, 2)
        r.x = 0
        r.y = 0
    ...
    def test_I_area(self):
        '''Tests area() method calculations.'''
        r = Square(6)
...
"""
    ...
    def test_K_str_no_args(self):
        '''Checks __str__() method signature.'''
        r = Square(5, 2)
        with self.assertRaises(TypeError) as e:
            Square.__str__()
    ...
    def test_K_str(self):
        '''Verifies __str__() method return value.'''
        r = Square(5)
        s = '[Square] (1) 0/0 - 5'
    ...
    def test_L_update_args(self):
        '''Checks update() with positional arguments.'''
        r = Square(5, 2)
        d = r.__dict__.copy()
    ...
    def test_L_update_args_bad(self):
        '''Tests update() with invalid arguments.'''
        r = Square(5, 2)
        d = r.__dict__.copy()
    ...
    def test_L_update_kwargs(self):
        '''Verifies update() with keyword arguments.'''
        r = Square(5, 2)
        d = r.__dict__.copy()
    ...
    def test_M_to_dictionary(self):
        '''Examines to_dictionary() method signature.'''
        with self.assertRaises(TypeError) as e:
